...
from utils import COCO_IMAGES_DIR, CAPTIONS_PATH, STIMULI_IDS_PATH, LANG_CLS_FEAT_KEY, VISION_MEAN_FEAT_KEY, \
...
if __name__ == "__main__":
    ...
    ds = CoCoDataset(COCO_IMAGES_DIR, CAPTIONS_PATH, STIMULI_IDS_PATH, 'caption')
