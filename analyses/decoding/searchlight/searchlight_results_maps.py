...
def create_gifti_results_maps(args):
    ...
    for hemi in HEMIS:
        ...
        attended = sc[(sc.training_mode == MODALITY_AGNOSTIC) & (sc.metric == TEST_CAPTIONS_ATTENDED)]
        unattended = sc[(sc.training_mode == MODALITY_AGNOSTIC) & (sc.metric == TEST_CAPTIONS_UNATTENDED)]
