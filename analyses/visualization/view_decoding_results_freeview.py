...
from eval import ACC_IMAGERY, ACC_IMAGERY_WHOLE_TEST, ACC_IMAGERY_NO_STD_MOD_AGNOSTIC, \
...
METRICS = T_VAL_METRICS + [METRIC_DIFF_MOD_AGNOSTIC_MOD_SPECIFIC, METRIC_CROSS_DECODING, ACC_IMAGERY_NO_STD_MOD_AGNOSTIC, ACC_IMAGERY_WHOLE_TEST_SET_NO_STD_MOD_AGNOSTIC]
