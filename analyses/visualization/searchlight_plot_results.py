...
RESULT_METRICS = [METRIC_IMAGERY_DECODER_COMPARISON_AGNOSTIC_IMAGES, METRIC_IMAGERY_DECODER_COMPARISON_AGNOSTIC_CAPTIONS] + T_VAL_METRICS + TARGET_TFCE_VAL_METRICS
