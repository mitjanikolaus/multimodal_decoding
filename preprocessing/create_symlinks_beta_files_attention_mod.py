...
from preprocessing.make_spm_design_job_mat_attention_mod import SPLIT_TEST_IMAGE_UNATTENDED, SPLIT_TEST_CAPTION_ATTENDED, \
    SPLIT_TEST_CAPTION_UNATTENDED, FIXATION, SPLIT_TEST_IMAGE_ATTENDED, FIXATION_WHITESCREEN
from utils import ATTENTION_MOD_SUBJECTS, ATTENTION_MOD_FMRI_BETAS_DIR

SPLITS = [SPLIT_TEST_IMAGE_ATTENDED, SPLIT_TEST_IMAGE_UNATTENDED, SPLIT_TEST_CAPTION_ATTENDED, SPLIT_TEST_CAPTION_UNATTENDED, IMAGERY, FIXATION,
