...
mlab.MatlabCommand.set_default_paths('/home/milad/apps/spm12')
from fmrikit import plot_motion
...
if __name__ == "__main__":
    ...
    subjects = [os.path.basename(p) for p in glob.glob('/mnt/HD1/milad/multimodal_decoding/fmri_data/bids/sub-*')]
    print(subjects)
    print()

    # list subject sessions
    data_root = '/mnt/HD1/milad/multimodal_decoding/fmri_data/bids/'
    anat_root = '/mnt/HD1/milad/multimodal_decoding/fmri_data/corrected_anat/'
    sessions = dict()
    ...
    # Working directory
    workflow_dir = '/mnt/HD1/milad/multimodal_decoding/preprocessed_data/'
